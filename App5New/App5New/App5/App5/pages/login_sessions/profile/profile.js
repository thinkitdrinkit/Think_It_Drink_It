...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/login_sessions/profile/profile.html", {
        ...
        ready: function (element, options) {
            ...
            if ((roamingSettings.values["numberOfPurchases"] / 10) % 1 === 0 && (roamingSettings.values["numberOfPurchases"] / 20) % 1 != 0 && (roamingSettings.values["numberOfPurchases"] / 30) % 1 === 0) {

            } else if ((roamingSettings.values["numberOfPurchases"] / 20) % 1 === 0) {

            } else if ((roamingSettings.values["numberOfPurchases"] / 30) % 1 != 0) {
