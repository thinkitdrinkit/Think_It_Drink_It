...
(function () {
        ...
        function layout(item, data) {
            ...
            _.each(links, function(link, l) {
                ...
                link.addEventListener('click', function (args) {
                    if (WinJS.Utilities.hasClass(args.currentTarget, "ageGroupHeader")) {
                        //Go to ageGroup Page
                        var ageGroup = args.currentTarget.getAttribute('data-state');
                        nav.navigate(args.currentTarget.href, { item: ageGroup });
                    }
                    else {
                        // Go to Product Page
    ...
    ui.Pages.define("/pages/base/base.html", {
        ...
        ready: function (element, options) {
            ...
            listView.itemDataSource = vm.ageGroups;
