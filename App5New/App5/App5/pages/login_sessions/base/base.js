...
(function () {
    ...
    var keepInfo = true;
    WinJS.UI.Pages.define("/pages/login_sessions/base/base.html", {
    ...
    WinJS.Namespace.define("base_clicked", {
        ...
        next_page_flavor: function () {
            keepInfo = false;
            if (base3 === "Protein") {
                WinJS.Navigation.navigate('pages/login_sessions/protein/protein.html');
            } else {
                WinJS.Navigation.navigate('pages/login_sessions/flavor/flavor.html')
