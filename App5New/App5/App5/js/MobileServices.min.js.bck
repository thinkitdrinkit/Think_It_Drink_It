    ...
    n.MobileServiceClient = function (n) {
        ...
        n.MobileServiceClient = MobileServiceClient, r.addToMobileServicesClientNamespace({
            ...
            i.isString(n, "apiName"), t.isNull(u) && typeof r == "function" && (u = r, r = null), i.notNull(u, "callback"), t.isNull(r) || (f = r.parameters, t.isNull(f) || i.isValidParametersObject(r.parameters), e = r.method, s = r.body, h = r.headers), t.isNull(e) && (e = "POST"), o = t.url.combinePathSegments("api", n), t.isNull(f) || (c = t.url.getQueryString(f), o = t.url.combinePathAndQuery(o, c)), this._request(e, o, s, null, h, function (n, i) {
                if (t.isNull(n)) {
                    if (typeof i.getResponseHeader == "undefined") try {
                        i.result = t.fromJson(i.responseText)
                    } catch (r) { } else i.getResponseHeader("Content-Type").toLowerCase().indexOf("json") !== -1 && (i.result = t.fromJson(i.responseText));
                    u(null, i)
                } else u(n, null)
            })
        ...
        n.MobileServiceLogin = MobileServiceLogin, r.addToMobileServicesClientNamespace({
            ...
            t.isNull(f) && (t.isNull(u) || typeof u != "function" ? t.isNull(r) || typeof r != "function" || (f = r, u = null, r = null) : (f = u, u = null)), t.isNull(u) && (t.isBool(r) ? (u = r, r = null) : u = !1), t.isNull(r) && t.isString(n) && n.split(".").length === 3 && (r = n, n = null), t.isNull(n) && (i.notNull(r), i.isString(r)), t.isNull(r) && (i.notNull(n), i.isString(n), n = n.toLowerCase()), t.isNull(n) ? this.loginWithMobileServiceToken(r, f) : this.loginWithProvider(n, r, u, f)
        ...
        n.async = function (n) {
            ...
            var f = Windows.Security.Authentication.Web.WebAuthenticationBroker,
                s = Windows.Security.Authentication.Web.WebAuthenticationOptions.none,
                l = Windows.Security.Authentication.Web.WebAuthenticationStatus.success,
                e = null,
                o = null;
            if (i.isNull(u) || (e = function (n) {
                var r = null,
                    o = null,
                    f, e, t;
                if (n.responseStatus !== l) r = n;
            else if (f = n.responseData, e = null, i.isNull(r) && (t = f.indexOf("#token="), t > 0 ? e = decodeURIComponent(f.substring(t + 7)) : (t = f.indexOf("#error="), t > 0 && (r = decodeURIComponent(f.substring(t + 7))))), !i.isNull(e)) try {
                    o = i.fromJson(e)
            } catch (s) {
                    r = s
            }
                ...
                var a = f.getCurrentApplicationCallbackUri().absoluteUri,
                    v = n + "?sso_end_uri=" + encodeURIComponent(a),
                    y = new Windows.Foundation.Uri(v);
            ...
            var n = "Unknown",
                t = Windows.ApplicationModel.Package.current.id.architecture;
            switch (t) {
                case 0:
                    n = "X86";
                    break;
            ...
            var t = Windows.ApplicationModel.Resources.Core.ResourceManager.current,
                i = t.mainResourceMap.getValue("MobileServices/Resources/" + n);
            return i.valueAsString
        }, n.allowPlatformToMutateOriginal = function (n, t) {
            if (!i.isNull(n) && !i.isNull(t)) {
                var r = null,
                    u = WinJS.Binding.as(n);
                ...
                return e(JavaScriptToQueryVisitor, n), JavaScriptToQueryVisitor.prototype.getSource = function (n) {
                    ...
                    return u = function (t) {
                        ...
                        if (n.callee.type === "MemberExpression" && ((f = n.callee.object) != null ? f.__hasThisExp : void 0) === !0) {
                            ...
                            if (i === "substring" || i === "substr") return new t.InvocationExpression(t.Methods.Substring, s(r, "substring"));
        ...
        (function (t, i) {
            ...
            function skipMultiLineComment() {
                ...
                for (r.comments && (i = t - 2, f = {
                    ...
                    if (n = u.charCodeAt(t), isLineTerminator(n)) n === 13 && u.charCodeAt(t + 1) === 10 && ++t, ++h, ++t, l = t, t >= a && throwError({}, e.UnexpectedToken, "ILLEGAL");
                    else if (n === 42) {
            ...
            function skipComment() {
                for (var n; t < a;)
                    ...
                    else if (isLineTerminator(n))++t, n === 13 && u.charCodeAt(t) === 10 && ++t, ++h, l = t;
                    else if (n === 47)
            ...
            function scanHexEscape(n) {
                for (var e, r = 0, f = n === "u" ? 4 : 2, i = 0; i < f; ++i)
                    if (t < a && isHexDigit(u[t])) e = u[t++], r = r * 16 + "0123456789abcdef".indexOf(e.toLowerCase());
                    else return "";
            ...
            function scanPunctuator() {
                ...
                if (o = u[t + 1], c = u[t + 2], v = u[t + 3], i === ">" && o === ">" && c === ">" && v === "=") return t += 4, {
                    type: f.Punctuator,
                    value: ">>>=",
                    lineNumber: h,
                    lineStart: l,
            ...
            function scanNumericLiteral() {
                ...
                if (n === "e" || n === "E")
                    if (i += u[t++], n = u[t], (n === "+" || n === "-") && (i += u[t++]), isDecimalDigit(u.charCodeAt(t)))
                        while (isDecimalDigit(u.charCodeAt(t))) i += u[t++];
                    else throwError({}, e.UnexpectedToken, "ILLEGAL");
            ...
            function scanStringLiteral() {
                ...
                for (o = u[t], assert(o === "'" || o === '"', "String literal must starts with a quote"), v = t, ++t; t < a;)
                    if (n = u[t++], n === o) {
                        ...
                        } else if (isLineTerminator(n.charCodeAt(0))) break;
                        else i += n; return o !== "" && throwError({}, e.UnexpectedToken, "ILLEGAL"), {
            ...
            function scanRegExp() {
                ...
                for (c = null, skipComment(), v = t, n = u[t], assert(n === "/", "Regular expression literal must start with a slash"), i = u[t++]; t < a;)
                    if (n = u[t++], i += n, p) n === "]" && (p = !1);
                    else if (n === "\\") n = u[t++], isLineTerminator(n.charCodeAt(0)) && throwError({}, e.UnterminatedRegExp), i += n;
                    else if (n === "/") {
                        b = !0;
                        break
            ...
            function throwUnexpected(n) {
                if (n.type === f.EOF && throwError(n, e.UnexpectedEOS), n.type === f.NumericLiteral && throwError(n, e.UnexpectedNumber), n.type === f.StringLiteral && throwError(n, e.UnexpectedString), n.type === f.Identifier && throwError(n, e.UnexpectedIdentifier), n.type === f.Keyword) {
                    if (isFutureReservedWord(n.value)) throwError(n, e.UnexpectedReserved);
            ...
            function parseObjectProperty() {
                ...
                else return r = parseObjectPropertyKey(), expect(":"), t = parseAssignmentExpression(), i.markEnd(i.createProperty("init", r, t))
            }
            ...
            function parseBinaryExpression() {
                ...
                for (f.prec = e, lex(), u = [t, createLocationMarker()], a = parseUnaryExpression(), n = [h, f, a];
                    (e = binaryPrecedence(c, l)) > 0;) {
            ...
            function filterTokenLocation() {
                for (var n, i, u = [], t = 0; t < r.tokens.length; ++t) n = r.tokens[t], i = {
                    type: n.type,
                    value: n.value
