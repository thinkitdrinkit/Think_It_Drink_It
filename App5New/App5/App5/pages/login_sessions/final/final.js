...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/login_sessions/final/final.html", {
        ...
        ready: function (element, options) {
            ...
            if (roamingSettings.values["Base_name"] === "Choc. Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Pea Protein") {
        ...
        clicked: function () {
            ...
            var query = Age.where({
                ...
                if (roamingSettings.values["Boost2_name"] != "" && roamingSettings.values["Boost3_name"] === "") {
                    if (roamingSettings.values["Base_name"] === "Choc. Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Pea Protein") {
                        WinJS.xhr({
                            ...
                            data: JSON.stringify({
                                ...
                                "total_tax": (roamingSettings.values["total_price"] % 6.36),
                                "note": "New Order",
                            ...
                            data: JSON.stringify({
                                ...
                                "register_sale_products": [
                                   ...
                                   },
                                   {
                                       ...
                                       "tax": (roamingSettings.values["FlavSel_price"] % 6.36)
                                   },
                                   {
                                       "product_id": roamingSettings.values["Boost1_vend"],
                                       "quantity": 1,
                    ...
                    if (roamingSettings.values["Base_name"] === "Choc. Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Whey Protein" || roamingSettings.values["Base_name"] === "Vanilla Whey Protein") {
                        WinJS.xhr({
                            type: "POST",
                            url: "http://thinkitdrinkit.vendhq.com/api/register_sales",
                            headers: { "Content-type": "application/json" },
                            ...
                            data: JSON.stringify({
                                ...
                                "register_sale_products": [
                                   ...
                                   },
                                   {
                                       ...
                                       "tax": (roamingSettings.values["Boost3_price"] % 6.36)
                                   }
                                ]
                            }),
                        }).then(function sucess(res) {
